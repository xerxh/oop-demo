...
function calLength2(x1, y1, x2, y2) { //算出两点之间的距离  碰撞检测 30==<900
...
function lerpAngle(a, b, t) {   //返回幅度值
	var d = b - a;
...
function lerpDistance(aim, cur, ratio) {  //计算返回值-->趋向目标值
	var delta = cur - aim;					//aim 目标坐标值
	return aim + delta * ratio;				//cur 当前坐标值
}											//ratio 0.9-0.98  游动快 一些快
